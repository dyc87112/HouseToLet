...
<div class="container" style="width: 100%">
	<form:form commandName="rental" class="form-horizontal" action="./${rental.id }" method="post">
		<fieldset>
			<legend>编辑租赁关系</legend>
			<div class="control-group">
				<label class="control-label">租赁的房间：</label>
				<div class="controls">
					<form:select path="room.id">
						<form:option value="${rental.room.id }">${rental.room.name }</form:option>
					</form:select>
				</div>
			</div>
			<div class="control-group">
