...
<div class="container" style="width: 100%">
	<form:form commandName="payment" class="form-horizontal" 
				action="./create?rentalId=${rental.id }&isFirst=false&isClose=false" method="post">
		<fieldset>
			<legend>账单结算（月结）-- <a href="#" style="color: red;">${rental.room.name }房间</a></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="basePayment" type="text" readonly="true" />（单位：元）
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">结算日期：</label>
				<div class="controls">
					<form:input path="startDate" type="text" readonly="true" /> 至 <form:input path="endDate" type="text" readonly="true" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="startElect" type="text" placeholder="请输入电表读数" readonly="true" />（单位：千瓦时）
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="startWater" type="text" placeholder="请输入水表读数" readonly="true" />（单位：吨）
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					</form:select>（网费：${rental.user.netPrice }元/月）
				</div>
			</div>
			<div class="control-group">
