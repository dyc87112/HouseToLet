...
<div class="container" style="width: 100%">
	<form:form commandName="payment" class="form-horizontal" 
				action="./create?rentalId=${rental.id }&isFirst=true&isClose=false" method="post">
		<fieldset>
			<legend>账单结算（开房）--<a href="#" style="color: red;">${rental.room.name }房间</a></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="basePayment" type="text" readonly="true" />（元）
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="startElect" type="text" placeholder="请输入电表读数" />（单位：千瓦时）
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="startWater" type="text" placeholder="请输入水表读数" />（单位：吨）
				</div>
			</div>
			<div class="control-group" style="display:none;">
